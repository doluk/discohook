...
`DISCORD_PROXY_API`, `APPLICATIONS_RAW`, `BOUNCER_ORIGIN`, `BOUNCER_JWT_KEY`, `DEV_GUILD_ID`, `DEV_OWNER_ID`, `KOFI_WEBHOOK_TOKEN`, `CRYPTO_ALERTS_TOKEN`, `BITCOIN_ADDRESS`, and `GIST_TOKEN`.
